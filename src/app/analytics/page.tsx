...
import { useRoles } from '../../lib/auth-utils';
...
export default function AnalyticsPage() {
  ...
  const [isRequestingAccess, setIsRequestingAccess] = useState(false);
    ...
    // Simple role checking - just like your sidebar
...
console.log('Has Data Analyst?', hasAnalyticsAccess);

  const handleRequestAccess = async () => {
    setIsRequestingAccess(true);
    try {
      // Call Auth0 action to request access
      const response = await fetch('/api/request-analytics-access', {
        method: 'POST',
        headers: {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <Alert className="mb-6">
            ...
            <AlertDescription>
              You need Data Analyst role permissions to access this page.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Access reporting analytics and data insights
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-muted-foreground mb-6">
                You don't currently have access to view analytics data. 
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Detailed analytics for report generation and usage
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">
              Advanced analytics charts and data visualizations would go here.
              This would include report generation trends, user engagement metrics,
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              User behavior analytics including session duration, feature usage,
              and engagement patterns would be displayed here.
            </p>
          </CardContent>
        </Card>
      </div>
